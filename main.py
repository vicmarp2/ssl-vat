...
def main(args):
    ...
    # get test error
    test_error(test_dataset, './models/best_model_cifar10_4000_0.6_8.pt')
    #test_error(test_dataset, './models/best_model_cifar10_250_0.6_8.pt')
    #test_error(test_dataset, './models/best_model_cifar100_10000_0.6_8.pt')
    #test_error(test_dataset, './models/best_model_cifar100_2500_0.6_8.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--max-grad-norm', default=1, type=float,
